...
struct Base_Character Trailblazer_des = {620.93, 460.84, 1203.5, 100.00, 125.00, 4, 1};

struct Base_Character Trailblazer_pre = {601.52, 606.38, 1241.86, 95.00, 150.00, 1, 6};
